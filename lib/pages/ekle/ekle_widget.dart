...
import 'ekle_model.dart';
export 'ekle_model.dart';

class EkleWidget extends StatefulWidget {
  const EkleWidget({super.key});

  @override
  State<EkleWidget> createState() => _EkleWidgetState();
}

class _EkleWidgetState extends State<EkleWidget> {
  late EkleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EkleModel());

    _model.hesapAdiController ??= TextEditingController();
    ...
    _model.sifreController ??= TextEditingController();
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              validator: _model.kullaniciAdiControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ],
